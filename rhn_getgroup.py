...
# Description: Get groupmembership for a host
#
...
def usage():
	print "Gets group values from Satellite"
	print "getgroup.py "
	print "-u USER"
	print "-p PASSWORD"
	print "-s https://SERVER/rpc/api"
	print ""
	print "Example: getgroup.py -u custom -p custom -s https://rhn.redhat.com/rpc/api"
...
sid = int(getSystemID())
values= server.system.listGroups(rhnSession,sid)
print values
